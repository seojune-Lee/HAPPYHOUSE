...
public class HouseDaoImpl implements HouseDao{
	...
	public HouseDeal search(int no) {
		...
		for (HouseDeal houseDeal : search) {
			if(houseDeal.getNo() == no) {
				HouseDeal find = new HouseDeal(no);
				find.setAptName(houseDeal.getAptName());
				find.setArea(houseDeal.getArea());
				find.setBuildYear(houseDeal.getBuildYear());
				find.setCode(houseDeal.getCode());
				find.setDong(houseDeal.getDong());
				find.setJibun(houseDeal.getJibun());
				find.setLat(houseDeal.getLat());
				find.setLng(houseDeal.getLng());
				find.setImg(houseDeal.getImg());
				return find;
			}
		}
		return null;
	...
	public String searchImg(String aptName) {
		if(houseInfo.get(aptName)!=null) return houseInfo.get(aptName).getImg();
		return "";
